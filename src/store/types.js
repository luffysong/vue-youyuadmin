...
// getter 可转让收益
export const PROJECTTRANSFEREARN_GET = 'PROJECTTRANSFEREARN_GET';

// 项目管理 获取项目进度
export const PROJECTPROGRESS_REQ = 'PROJECTPROGRESS_REQ';
export const PROJECTPROGRESS_SUC = 'PROJECTPROGRESS_SUC';
export const PROJECTPROGRESS_ERR = 'PROJECTPROGRESS_ERR';
